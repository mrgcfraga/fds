...
LOGICAL :: RADIATION=.TRUE.,RADIATION_COMPLETED=.TRUE.,EXCHANGE_RADIATION=.FALSE.,KAPPA_ARRAY=.FALSE.,CYLINDRICAL,NOISE, &
           ...
           THERMOPHORETIC_SETTLING=.TRUE.,TURBULENT_DEPOSITION=.TRUE., DEPOSITION=.TRUE., &
           VELOCITY_ERROR_FILE=.FALSE.,CFL_FILE=.FALSE.,CONSTANT_SPECIFIC_HEAT_RATIO=.FALSE.,MEAN_FORCING(3)=.FALSE.,&
           CHECK_HT=.FALSE.,PATCH_VELOCITY=.FALSE.,OVERWRITE=.TRUE.,INIT_HRRPUV=.FALSE.,WFDS_BNDRYFUEL=.FALSE., &
...
REAL(EB) :: CPOPR,RSC,RPR,TMPA,TMPA4,RHOA,P_INF,RADIATIVE_FRACTION, &
            ...
            LIMITING_DT_RATIO=1.E-4_EB,HRRPUV_CUT,HRRPUV_CUT_MAX=200._EB, NOISE_VELOCITY=0.005_EB, &
...
REAL(EB) :: Y_O2_INFTY=0.232378_EB,Y_CO2_INFTY=0.000595_EB,Y_H2O_INFTY=0._EB,&
            ...
            H_F_REFERENCE_TEMPERATURE=25._EB,EXTINCTION_1_TMP_CUTOFF=1.E6_EB
...
REAL(EB) :: QR_CLIP,C_MAX,C_MIN=1._EB
REAL(EB), ALLOCATABLE, DIMENSION(:) :: RTE_SOURCE_CORRECTION_FACTOR,RAD_Q_SUM,KFST4_SUM
