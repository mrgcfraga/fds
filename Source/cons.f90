...
! SLW parameters
INTEGER :: NUMBER_OF_RAD_SPECIES,SLW1_NGASES
REAL(EB) :: SLW_FMAX,SLW_FMIN,SLW_CMIN,SLW_CMAX,SLW1_LENGTH(2)
CHARACTER(20) :: SLW_QUADRATURE,slw_mixture_method,SLW1_APPROACH,&
   SLW_NONUNIFORM_METHOD
CHARACTER(100) :: ALBDF_FILE(5),ALBDF_INFO_FILE(5)
