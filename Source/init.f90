...
USE GEOMETRY_FUNCTIONS, ONLY: ASSIGN_PRESSURE_ZONE,ASSIGN_HT3D_WALL_INDICES
USE RADCONS, ONLY: UIIDIM
USE CONTROL_VARIABLES
USE MATH_FUNCTIONS, ONLY:EVALUATE_RAMP
INTEGER :: N,NN,I,J,K,IW,IC,SURF_INDEX,IOR,IERR,IIG,JJG,KKG,N_OVERLAP,IZERO,II,JJ,KK,I_OBST
...
USE CONTROL_VARIABLES
INTEGER :: N,I,J,K,II,JJ,KK,IPTS,JPTS,KPTS,N_EDGES_DIM,IW,IC,ICG,IOR,IERR,IPZ,NOM,ITER,IZERO,IIG,JJG,KKG
INTEGER, INTENT(IN) :: NM
...
IF (OBST_INDEX>0 .AND. .NOT.EVACUATION_ONLY(NM)) THEN
   ...
   WC%ONE_D%AREA_ADJUST = SF%AREA_ADJUST*OBX%INPUT_AREA(ABS(IOR))/OBX%FDS_AREA(ABS(IOR))
...
PROCESS_VENT: IF (WC%VENT_INDEX>0) THEN
   ...
   IF (.NOT.EVACUATION_ONLY(NM)) THEN
   WC%ONE_D%AREA_ADJUST = SF%AREA_ADJUST*VT%INPUT_AREA/VT%FDS_AREA
   IF (WC%ONE_D%AREA_ADJUST<=TWO_EPSILON_EB) WC%ONE_D%AREA_ADJUST = 1._EB
   ENDIF
