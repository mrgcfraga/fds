...
TYPE MESH_TYPE
   ...
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:) :: &
            ...
            CSD2,CHEM_SUBIT,MIX_TIME,STRAIN_RATE,D_Z_MAX,AIT,Q_DOT_PPP_S,CO2_MOLAR_FRACTION,H2O_MOLAR_FRACTION
...
REAL(EB), POINTER, DIMENSION(:,:,:) :: &
   ...
   CO2_MOLAR_FRACTION,H2O_MOLAR_FRACTION
...
!rm <-
CO2_MOLAR_FRACTION=>M%CO2_MOLAR_FRACTION
H2O_MOLAR_FRACTION=>M%H2O_MOLAR_FRACTION
