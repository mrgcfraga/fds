...
NAMELIST /RADI/ ANGLE_INCREMENT,BAND_LIMITS,C_MAX,C_MIN,INITIAL_RADIATION_ITERATIONS,KAPPA0,&
                ...
                TIME_STEP_INCREMENT,WIDE_BAND_MODEL,WSGG_MODEL,SLW_FMAX,SLW_FMIN,SLW_QUADRATURE,&
                SLW_MIXTURE_METHOD,NUMBER_OF_RAD_SPECIES,ALBDF_FILE,ALBDF_INFO_FILE,&
                NUMBER_OF_RAD_SPECIES,SLW1_APPROACH,SLW1_NGASES,SLW_NONUNIFORM_METHOD,SLW_CMIN,SLW_CMAX,&
                SLW1_LENGTH,ALBDF_FILE,ALBDF_INFO_FILE

REAL(EB) THETALOW,THETAUP
INTEGER  NRA,N

! Set default values
SLW_NONUNIFORM_METHOD = 'I.2.1'
SLW1_NGASES = 20
SLW1_LENGTH(1) = 0.2_EB
SLW1_LENGTH(2) = 1.0_EB
